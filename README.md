...
Relational databases are a type of database, while SQL is a language to interact with databases.

2. Why do tables need a `primary key`?
To make sure there is at least one column that is unique to differentiate the row data and serve as an identifier.

3. What is the name given to a table column that references the primary key on another table.
Foreign key.

4. What do we need in order to have a _many to many_ relationship between two tables.
An intermediate table to reference both tables.
